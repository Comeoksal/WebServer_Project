...
<table style="width: 100%; border-collapse: collapse; color: white; margin-top: 20px;">
 <thead style="background-color: #444;">
  ...
  <form action="processLikeReview.jsp" method="post" style="display: inline;">
    ...
    <button type="submit" style="background: none; border: 1px solid #ccc; color: #58a6ff; cursor: pointer; border-radius: 8px; padding: 4px 10px;">
      ❤️ ${row.like_count}
    </button>
  </form>
</td>
...
<div style="text-align: center; margin-top: 20px;">
  <form method="get">
    <button type="submit" name="page" value="${page - 1}" ${page <= 1 ? "disabled" : ""}>이전</button>
    <span>페이지 ${page}</span>
