...
<header class="d-flex justify-content-between align-items-center px-4 py-3 bg-dark text-white">
    <div class="d-flex gap-2 align-items-center">
        <div class="fs-4 fw-bold" ><a href="${pageContext.request.contextPath}/admin/home_admin.jsp" style="text-decoration: none; color: #FFFFFF;'"><fmt:message key="admin_header_title" /></a></div>
   ...
   <div class="d-flex ms-auto gap-2">
   		<a href="${pageContext.request.contextPath}/home.jsp" class="btn btn-outline-light"><fmt:message key="admin_header_userpage" /></a>
        <a href="?lang=ko" class="btn btn-light btn-sm me-1"><fmt:message key="admin_header_korean" /></a>
        <a href="?lang=en" class="btn btn-light btn-sm"><fmt:message key="admin_header_english" /></a>
    </div>
</header>
</fmt:bundle>