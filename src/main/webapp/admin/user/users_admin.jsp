...
<body>
    ...
    <div class="container mt-5">
        <div class="d-flex align-items-center justify-content-between mb-2 w-100">
    		<h2 class="mb-0 flex-grow-1"><fmt:message key="admin_users_main" /></h2>
    		<a href="addUser_admin.jsp" class="btn btn-success btn-sm ms-3"><fmt:message key="admin_users_add" /></a>
		</div>
            ...
            <tbody>
                <c:forEach var="row" items="${result.rows}">
                    <tr>
            			...
            			<td>
            				<a href="processDeleteUser_admin.jsp?id=${row.id}" class="btn btn-danger btn-sm" onclick="return confirm('정말 삭제하시겠습니까?');"><fmt:message key="admin_delete" /></a>
            			</td>
                    </tr>
                </c:forEach>
            </tbody>
